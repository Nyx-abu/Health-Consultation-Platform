...
import rayzor from '../../assets/razorpay-icon.svg'
        ...
        {[1, 2, 3, 4].map((step) => (
          <div key={step} className="flex flex-col items-center z-10">
            ...
            <motion.div
              ...
              className={`text-xs mt-2 font-medium text-center ${currentStep >= step ? "text-gray-800" : "text-gray-400"}`}
            >
  ...
  const renderPersonalInfoStep = () => {
    return (
      ...
      >
          ...
          <motion.div variants={itemVariants} className="space-y-2">
            ...
            <div className="relative">
              <input
                ...
                className={`w-full px-4 py-3 border ${formErrors.firstName ? "border-red-500" : "border-gray-300"} rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 bg-white shadow-sm`}
          ...
          <motion.div variants={itemVariants} className="space-y-2">
            ...
            <div className="relative">
              <input
                ...
                onChange={handleChange}
                className={`w-full px-4 py-3 border ${formErrors.lastName ? "border-red-500" : "border-gray-300"} rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 bg-white shadow-sm`}
          ...
          <motion.div variants={itemVariants} className="space-y-2">
            ...
            <div className="relative">
              <input
                ...
                onChange={handleChange}
                className={`w-full px-4 py-3 border ${formErrors.email ? "border-red-500" : "border-gray-300"} rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 bg-white shadow-sm`}
          ...
          <motion.div variants={itemVariants} className="space-y-2">
            ...
            <div className="relative">
              <input
                ...
                onChange={handleChange}
                className={`w-full px-4 py-3 border ${formErrors.phone ? "border-red-500" : "border-gray-300"} rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 bg-white shadow-sm`}
          ...
          <motion.div variants={itemVariants} className="space-y-2">
            ...
            <div className="relative">
              <input
                ...
                onChange={handleChange}
                className={`w-full px-4 py-3 border ${formErrors.dateOfBirth ? "border-red-500" : "border-gray-300"} rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 bg-white shadow-sm`}
              />
          ...
          <motion.div variants={itemVariants} className="space-y-2">
            ...
            <div className="relative">
              <select
                ...
                onChange={handleChange}
                className={`w-full px-4 py-3 border ${formErrors.gender ? "border-red-500" : "border-gray-300"} rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 bg-white shadow-sm appearance-none`}
              >
        ...
        <motion.div variants={itemVariants} className="flex justify-end items-center pt-6 mt-8">
          <button
            type="button"
      ...
      >
        ...
        <motion.div variants={itemVariants} className="space-y-2">
          ...
          <div className="relative">
            <input
              ...
              onChange={handleChange}
              className={`w-full px-4 py-3 border ${formErrors.address ? "border-red-500" : "border-gray-300"} rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 bg-white shadow-sm`}
          ...
          <motion.div variants={itemVariants} className="space-y-2">
            ...
            <div className="relative">
              <input
                ...
                value={formData.city}
                onChange={handleChange}
                className={`w-full px-4 py-3 border ${formErrors.city ? "border-red-500" : "border-gray-300"} rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 bg-white shadow-sm`}
                placeholder="City"
              />
          ...
          <motion.div variants={itemVariants} className="space-y-2">
            ...
            <div className="relative">
              <input
                ...
                onChange={handleChange}
                className={`w-full px-4 py-3 border ${formErrors.state ? "border-red-500" : "border-gray-300"} rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 bg-white shadow-sm`}
                placeholder="State"
              />
          ...
          <motion.div variants={itemVariants} className="space-y-2">
            ...
            <div className="relative">
              <input
                ...
                onChange={handleChange}
                className={`w-full px-4 py-3 border ${formErrors.zipCode ? "border-red-500" : "border-gray-300"} rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 bg-white shadow-sm`}
        ...
        <motion.div variants={itemVariants} className="mt-8 pt-6 border-t border-gray-200">
          <div className="flex items-center space-x-3 mb-6">
            ...
            <h3 className="text-xl font-bold text-gray-800">Select Appointment Date & Time</h3>
          </div>
            ...
            <motion.div variants={itemVariants} className="space-y-2">
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full px-4 py-3 border ${formErrors.appointmentDate ? "border-red-500" : "border-gray-300"} rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 bg-white shadow-sm`}
                />
                {formErrors.appointmentDate && (
                  <p className="text-red-500 text-xs mt-1">{formErrors.appointmentDate}</p>
                )}
              </div>
            </motion.div>
            ...
            <motion.div variants={itemVariants} className="space-y-2">
              ...
              <div className="relative">
                <select
                  ...
                  onChange={handleChange}
                  className={`w-full px-4 py-3 border ${formErrors.appointmentTime ? "border-red-500" : "border-gray-300"} rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 bg-white shadow-sm appearance-none`}
                >
  ...
  const renderPaymentStep = () => {
    return (
      ...
      >
        ...
        >
          ...
          <div className="bg-white rounded-lg p-4 border border-gray-200 shadow-sm transition-all duration-300 hover:shadow-md">
            <div className="flex flex-col sm:flex-row justify-between items-start gap-4">
              <div>
                <h4 className="font-bold text-lg text-gray-800">{cartItem.title}</h4>
              ...
              <div className="text-left sm:text-right mt-4 sm:mt-0">
                <div className="flex flex-col sm:items-end">
                  <span className="text-sm text-gray-500 line-through">₹{cartItem.originalPrice.toLocaleString()}</span>
                  <span className="text-2xl font-bold text-blue-600">₹{cartItem.discountedPrice.toLocaleString()}</span>
          ...
          <div className="border-2 border-blue-600 rounded-lg p-4 bg-blue-50 shadow-md mb-6">
            <div className="flex flex-col sm:flex-row items-center">
              <div className="bg-white p-2 rounded-md mb-3 sm:mb-0 sm:mr-3 h-12 w-32 flex items-center justify-center shadow-sm">
                <img src={rayzor} alt="Razorpay" className="h-8" />
              </div>
        ...
        <motion.div variants={itemVariants} className="bg-gray-50 rounded-lg p-4 sm:p-6 mb-6 border border-gray-200">
          <h3 className="text-lg font-bold text-gray-800 mb-4">Order Summary</h3>
          <div className="space-y-3">
            <div className="flex justify-between py-2 border-b border-gray-200">
              <span className="text-gray-600">{cartItem.title}</span>
              <span className="font-medium">₹{cartItem.discountedPrice.toLocaleString()}</span>
            </div>
            <div className="flex justify-between py-2 border-b border-gray-200">
        ...
        {formErrors.terms && <p className="text-red-500 text-xs -mt-4 mb-4">{formErrors.terms}</p>}
  ...
  const renderConfirmationStep = () => {
    return (
      ...
      >
        ...
        >
          <h3 className="font-bold text-xl text-gray-800 mb-4 text-left">Appointment Details</h3>
          <div className="space-y-4 text-left">
            ...
            <div className="flex">
              ...
              <div>
                ...
                <p className="text-blue-600 font-medium">₹{calculateGrandTotal().toLocaleString()} (Paid)</p>
              </div>
            </div>
          </div>
        </motion.div>
        ...
        >
          <div className="flex">
            ...
            <div className="text-left">
              <p className="font-bold text-yellow-800 text-lg">Important Instructions</p>
              <ul className="text-sm text-yellow-700 list-disc pl-5 mt-2 space-y-1">
                ...
                <li>Fast for 10-12 hours before your appointment (water is allowed)</li>
        ...
        <motion.div variants={itemVariants} className="mt-8">
          <p className="text-gray-500 mb-6">A confirmation email has been sent to {formData.email}</p>

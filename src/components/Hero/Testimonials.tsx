...
const TestimonialMarquee = () => {
  ...
  const testimonials: Testimonial[] = [
    ...
    {
      quote: "For reliable diagnostic services, I highly recommend Redcliffe Labs.",
      doctor: {
        name: "Dr. Arun Kumar",
        title: "Specialist",
        location: "Bengaluru",
    ...
    <div className="w-full bg-gradient-to-b from-white to-blue-50 py-8 md:py-16 px-4 overflow-hidden">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-8 md:mb-12">
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-blue-900 mb-3">What Doctors Are Saying</h2>
                ...
                <div className="pt-3 md:pt-4 border-t border-gray-100">
                  <div className="flex items-center">
                    ...
                    <div className="ml-3 md:ml-4">
                      <h4 className="font-bold text-sm md:text-base text-blue-900">{testimonial.doctor.name}</h4>
                      <p className="text-xs md:text-sm text-gray-600">{testimonial.doctor.title}</p>
                      <p className="text-xs text-gray-500">{testimonial.doctor.location}</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          {testimonials.map((_, index) => (
            <button
              ...
              className={`w-2.5 h-2.5 md:w-3 md:h-3 rounded-full transition-colors duration-300 ${
                activeIndex === index ? "bg-blue-500" : "bg-blue-300 hover:bg-blue-400"
              }`}

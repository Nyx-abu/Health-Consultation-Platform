...
import { Calendar, Clock, Home, ThumbsUp, Award, FileText, Phone, FlaskConical, Zap, LucideIcon } from "lucide-react"
...
const ServiceFeature = ({
  ...
  return (
    <div
      className="relative bg-white rounded-xl shadow-lg overflow-hidden h-full transform transition-all duration-300 hover:-translate-y-2 hover:shadow-xl border border-gray-100"
      style={{
...
const StatItem = ({ value, label, icon: Icon, color, bgColor, delay }: StatItemProps) => (
  <div
    className="flex flex-col items-center p-6 bg-white rounded-xl shadow-md border border-gray-100 transform transition-all duration-500 hover:shadow-lg hover:-translate-y-1"
    style={{
  ...
  >
    <div className={`w-20 h-20 rounded-2xl ${bgColor} flex items-center justify-center mb-4 shadow-sm`}>
...
const ServiceFeaturesSection = () => {
  ...
  return (
    <div className="w-full bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-50 py-20 px-4 sm:px-6 lg:px-8 overflow-hidden relative">
      {/* Background decorative elements */}
      <div className="absolute top-0 right-0 w-96 h-96 bg-blue-200 rounded-full mix-blend-multiply opacity-10 -mt-20 -mr-20 blur-3xl"></div>
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-indigo-200 rounded-full mix-blend-multiply opacity-10 -mb-20 -ml-20 blur-3xl"></div>
      <div className="absolute top-1/2 left-1/4 w-64 h-64 bg-purple-200 rounded-full mix-blend-multiply opacity-10 blur-3xl"></div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-gray-600 max-w-3xl mx-auto text-lg">
            According to the study presented at the 78th UN General Assembly, Redcliffe's tests are up to
            <span className="font-bold text-blue-700"> 8 times more cost-effective </span>
            than national treatment coverage.
          </p>
        </div>
        ...
        >
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-10 border border-gray-100">
            <div className="text-center mb-10">
              ...
              <p className="text-gray-600 text-lg">Delivering quality healthcare diagnostics across the nation</p>
            ...
            <div className="mt-12 bg-gradient-to-r from-blue-50 to-indigo-50 p-4 sm:p-8 rounded-xl border border-blue-100">
              <div className="flex flex-col md:flex-row items-center justify-between">
                ...
                <button
                  className="w-full md:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-medium rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 transform flex items-center justify-center"
                  style={{

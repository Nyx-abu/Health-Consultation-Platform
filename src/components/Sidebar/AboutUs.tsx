...
import { Award, ChevronRight, Clock, Home, Microscope, BarChart3, Users, Heart, Target, Zap, Globe, Shield, TrendingUp, ArrowRight, Check, Star } from 'lucide-react';
...
export default function PremiumAboutUs() {
  ...
  const testimonials = [
    {
      quote: "The home collection service was incredibly convenient. The phlebotomist was professional, and I received my reports within 24 hours. Excellent service!",
      name: "Ananya Patel",
      location: "Mumbai",
      image: "/images/testimonial-1.jpg"
    },
    {
      quote: "As someone with a busy schedule, their digital reports and easy booking system have made health monitoring so much easier. The accuracy and speed are impressive.",
      name: "Rahul Sharma",
      location: "Delhi",
      image: "/images/testimonial-2.jpg"
    },
    {
      quote: "The genetic testing services provided valuable insights for our family's health planning. The counseling support was exceptional and helped us understand the results.",
  ...
  const tabContent = [
    {
      title: "Our Mission",
      content: "We're on a mission to democratize access to quality healthcare diagnostics across India. By combining cutting-edge technology with medical expertise, we aim to make accurate testing available to everyone, regardless of location or economic status."
    },
    {
      title: "Our Vision",
      content: "We envision a future where preventive healthcare is the norm, not the exception. A world where every Indian has access to timely, accurate diagnostics that can detect health issues before they become critical, leading to longer, healthier lives."
    },
    {
      title: "Our Promise",
      content: "We promise unwavering commitment to quality, accessibility, and affordability. Every test we conduct meets the highest standards of accuracy, delivered with compassion and respect for the individual behind each sample."
    }
  ];
  ...
  return (
    <div className="bg-white overflow-hidden">
      ...
      >
        {/* Decorative elements */}
        <div className="absolute top-0 left-0 w-full h-20 bg-white" style={{ clipPath: 'polygon(0 0, 100% 0, 100% 100%, 0 0)' }} />
        <div className="absolute bottom-0 right-0 w-full h-20 bg-white" style={{ clipPath: 'polygon(0 100%, 100% 0, 100% 100%, 0 100%)' }} />
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Making a <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-300 to-cyan-300">Difference</span>
            </h2>
      ...
      >
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Comprehensive <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-300 to-cyan-300">Diagnostic Solutions</span>
            </h2>
            <p className="text-xl text-blue-100">
              At our labs, we've built a comprehensive portfolio approach with both routine and specialized test menus with advanced testing labs all over India.
            </p>
          </motion.div>
          ...
          >
            ...
            >
              ...
              <p className="text-blue-100 mb-6">
                Leveraging cutting-edge technology to make diagnostics more accessible, efficient, and user-friendly for all our patients.
              </p>
            ...
            >
              ...
              <p className="text-blue-100 mb-6">
                Quick turnaround times without compromising on quality, ensuring you get results when you need them most.
              </p>
              <a href="#" className="inline-flex items-center text-blue-300 hover:text-white transition-colors">
                Learn more <ArrowRight size={16} className="ml-2" />
              </a>
            ...
            >
              ...
              <p className="text-blue-100 mb-6">
                Convenience at your doorstep with our quick response home collection service, making healthcare truly accessible.
              </p>
              <a href="#" className="inline-flex items-center text-blue-300 hover:text-white transition-colors">
                Learn more <ArrowRight size={16} className="ml-2" />
              </a>
            ...
            <div className="relative z-10">
              <div className="text-center max-w-3xl mx-auto">
                ...
                <p className="text-xl text-blue-100 mb-10">
                  Whether you're looking for quality diagnostics or want to partner with us, we're here to make a difference together.
                </p>

...
import { ChevronLeft, Phone, MessageCircle, Mail, HelpCircle, MessageSquare, Users } from 'lucide-react';
  ...
  const renderMainSection = () => (
    <div className="max-w-6xl mx-auto p-6">
      <div className="flex items-center mb-8">
        ...
        >
          <ChevronLeft className="w-5 h-5 mr-1" onClick={()=> navigate('/')}/>
        ...
        <div className="md:col-span-2">
          <div className="bg-blue-50 rounded-xl p-8 shadow-sm">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <h2 className="text-2xl font-bold text-gray-800">We're here to help!</h2>
              </div>
            </div>
            <p className="text-gray-700 mt-2">
              If you have any queries related to any of our tests or packages, you can contact us on the below
              mentioned phone number or email. Our support team is available 24/7 to assist you.
            </p>
            
            <div className="mt-6 bg-white p-4 rounded-lg shadow-sm">
              <h3 className="font-semibold text-gray-700 mb-2">Common Questions</h3>
              <ul className="space-y-2">
                <li className="text-blue-600 hover:text-blue-800 cursor-pointer">How do I track my test status?</li>
                <li className="text-blue-600 hover:text-blue-800 cursor-pointer">What payment methods do you accept?</li>
                <li className="text-blue-600 hover:text-blue-800 cursor-pointer">How long do test results take?</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <h2 className="text-xl font-bold text-center my-10 text-gray-800">For specific questions, get in touch below</h2>
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-10">
        ...
        >
          ...
          <p className="text-gray-500 text-center mt-2">Find answers to commonly asked questions</p>
        </div>
        ...
        >
          ...
          <p className="text-gray-500 text-center mt-2">Submit your question for quick assistance</p>
        </div>
        ...
        >
          ...
          <p className="text-gray-500 text-center mt-2">Reach our team directly for personal support</p>
        </div>
      </div>
    </div>
  );
    ...
    <div className="max-w-3xl mx-auto p-6">
      <div className="flex items-center mb-8">
        ...
        >
          ...
          <span className="text-xl font-bold text-gray-800">Frequently Asked Questions</span>
        </button>
      </div>
      ...
      <div className="space-y-4">
        {[1, 2, 3, 4, 5].map((item) => (
          <div key={item} className="bg-white rounded-lg p-6 shadow-sm">
            <h3 className="font-bold text-gray-800">How long does it take to receive test results?</h3>
            <p className="text-gray-600 mt-2">
              Most test results are available within 24-48 hours after the sample reaches our laboratory. 
              Some specialty tests may take longer. You can check the status of your test through your online account.
            </p>
          </div>
        ))}
      </div>
  ...
  const renderQuerySection = () => (
    <div className="max-w-3xl mx-auto p-6">
      <div className="flex items-center mb-8">
        ...
        >
          <ChevronLeft className="w-5 h-5 mr-1" />
          <span className="text-xl font-bold text-gray-800">Submit a Query</span>
        </button>
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <p className="mt-2 text-gray-600">
              Redcliffe Labs Headquarters<br />
